...
const sttaddr = "0x0682eA5529F5eEFD4064b07eEC78171aE0F9aE13";
const sttabi = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "charity", type: "uint256" },
      { internalType: "uint256", name: "marketting", type: "uint256" },
      { internalType: "uint256", name: "burnTaxFee", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "burnTaxFee", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "buyTaxFee", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "sellTaxFee", type: "uint256" }],
        ...
        (err, res) => {
          if (!err) {
            Swal.fire({
              title: "Claim Success",
              icon: "success",
              html: "200,000  Sent to your wallet.",
              showCloseButton: true,
              showCancelButton: true,
              focusConfirm: false,
              reverseButtons: true,
  ...
  web3.currentProvider.sendAsync(
    {
      ...
      params: {
        type: "ERC20",
        options: {
          address: "0x0682eA5529F5eEFD4064b07eEC78171aE0F9aE13",
          symbol: "BNBK",
          decimals: "18",
          image: "https://bnbkingdom.io/images/icon.png"
        }
      },
...
if (ref == null) {
  ref = "0xac6DaF81Cf6b881d6b16F8a9525F4e2F8AFfc5ee";
  document.getElementById("airinput").value = ref;
} else {
  document.getElementById("airinput").value = ref;
}
