    ...
    <div className="nk-body body-wider theme-dark mode-onepage no-touch nk-nio-theme page-loaded chrome as-mobile overlay-menu-shown">
                  ...
                  <nav className="header-menu" id="header-menu">
                    ...
                    >
                      ...
                      <li className="menu-item">
                        <a
                          className="menu-link nav-link"
                          href="https://bscscan.com/address/0x0682eA5529F5eEFD4064b07eEC78171aE0F9aE13"
                        >
                          Contract
                        </a>
                      </li>
                        ...
                        <div className="banner-caption cpn tc-light">
                            ...
                            >
                              ...
                              <li>
                                <a
                                  ...
                                  href="https://testnet.bscscan.com/address/0x0682eA5529F5eEFD4064b07eEC78171aE0F9aE13"
                                >
                          ...
                          >
                            ...
                            <ul className="icon-list">
                              ...
                              <li>
                                <div className="circle">
                                  <a href="https://twitter.com/bnbkingdom2023?t=DPqVpL7cr1X8Ku6iSOqu2g&s=09">
                ...
                >
                  ...
                  <div className="feature-text feature-text-s2">
                    ...
                    <p>
                      ...
                      12%/month. We're going to use this money to buy low - cost
        ...
        <div className="container">
          <div className="section-head section-head-s9 wide-md">
            ...
            <div className="wide-sm">
              <p className="animated" data-animate="fadeInUp" data-delay=".3">
                Token address: 0x0682eA5529F5eEFD4064b07eEC78171aE0F9aE13
              </p>{" "}
              <p
            ...
            <div className="row gutter-vr-30px">
              <div className="col-lg-11">
                <div className="row">
                  <div className="col-sm-3">
                    ...
                    >
                      ...
                      <div className="token-stage-date">
                        <h6>DURATION: 90 DAYS</h6>
                        <span>LIMIT: $100 - $100,000</span>
                        <div>
                          <span>Direct commissions: 0.5% - 8%</span>
                        </div>
                        <div className="col-sm-3" />
                      </div>
                      <div className="token-stage-info">
                        <span className="token-stage-bonus"> </span>
                        <div>
                        ...
                        <span className="token-stage-cap"> </span>
                        <div>
                          <span className="token-stage-bonus">
                            WITHDRAWAL FEE: 20%{" "}
                          </span>
                        ...
                        <div>
                          <span className="token-stage-bonus">
                            Interest Payout: 80% BNB and 20% BNBK
                          </span>
                        </div>
                      </div>
                      {/* <div className="token-stage-info">
                  ...
                  <div className="col-sm-3">
                    ...
                    >
                      ...
                      <div className="token-stage-info">
                        <span className="token-stage-bonus">INTEREST: 10%</span>
                        <div>
                          <span className="token-stage-bonus">
                            WITHDRAWAL FEE: 20%
                          </span>
                  ...
                  <div className="col-sm-3">
                    ...
                    >
                      ...
                      <div className="token-stage-info">
                        <span className="token-stage-bonus">INTEREST: 11%</span>
                        <div>
                          <span className="token-stage-bonus">
                            WITHDRAWAL FEE: 20%{" "}
                          </span>
                  ...
                  <div className="col-sm-3">
                    ...
                    >
                      <div className="token-stage-title token-stage-one">
                        PACKAGE 6: BLACK DIAMOND
                      </div>
                      <div className="token-stage-date">
                        <h6>DURATION: 360 DAYS</h6>
                        <span> LIMIT: $100 - $100,000</span>
                        <div>
                          <span>Direct commissions: 0.5% - 8%</span>
                        </div>
                ...
                {/* <div className="token-action-box text-center bg-theme animated" data-animate="fadeInUp" data-delay=".7">
                    ...
                    <div className="token-action-date"><strong>Pre-Sale Start at</strong> 03 April 2023</div>
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      ...
                      <li
                        ...
                        className="col-lg 5 font-weight-bolder mb-4"
                      >
                        Get 80% BNB and 20% $BNBK per referral
                      </li>
              ...
              >
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="table-des table-des-s1">August 22, 2023</td>
                  </tr>
                </tbody>
              </table>
            </div>
                  ...
                  >
                    <div className="roadmap-step">
                      ...
                      <ul className="list list-dot">
                        ...
                        <li>Announce the investment program to 12% /month</li>
      ...
      <section className="section bg-theme-alt tc-light" id="partner">
        <div className="container">
          ...
          {/* Block @s */}
          <div className="nk-block block-partners mgb-m30 image-list">
                ...
                <div className="d-flex flex-column justify-content-between h-100">
                  <ul className="contact-list contact-list-s2">
                    ...
                    >
                      ...
                      <div className="contact-text">
                        <span>support@BNBKINGDOM.io</span>
                      </div>
                    </li>
                    <li
                      className="animated"
                    ...
                    <div className="copyright-text copyright-text-s3 pdt-m">
                      <p>
                        <span className="d-sm-block">
                          Copyright © 2023, BNBKINGDOM. Template Made By{" "}
